...
//        itemsArray.add(new Items(10,"dg", 5.57, 7,"/shoppingcart/images/red.jpg"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (isNumeric(jTextField1.getText()) && isNumeric(jTextField3.getText()) && isNumeric(jTextField4.getText())) {
            ShoppingCart.itemsArray.add(new Items(Integer.parseInt(jTextField1.getText()), jTextField2.getText(), Double.parseDouble(jTextField3.getText()), Integer.parseInt(jTextField4.getText())));
